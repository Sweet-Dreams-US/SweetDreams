...
export default function VideoPlayer({ videoId, className, playTextSize = 'large' }: VideoPlayerProps) {
  ...
  return (
    <div className={className}>
      <video
        ...
        poster={`https://customer-w6h9o08eg118alny.cloudflarestream.com/${videoId}/thumbnails/thumbnail.jpg?time=80s&height=600`}
        controls
        playsInline
