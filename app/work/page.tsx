...
export default function WorkPage() {
  ...
  const portfolioItems = [
    ...
    // Mix of camera-shot (no aerial tag) and drone-shot (aerial tag) hyperlapses.
    // Vertical (1080x1920 / 2160x3840)
    {
      image: "",
      title: "HOT CHICKS HYPERLAPSE",
      client: "Hot Chicks",
      logo: "https://fweeyjnqwxywmpmnqpts.supabase.co/storage/v1/object/public/media/logos/SWEETDREAMSLOGO_1.jpg",
      tags: ["hyperlapse"], // Camera-shot — no aerial tag
      date: "2026-05-06",
      isSmartVideo: true,
      videoId: "c57e05bc2ca2ddec9b679b9d4c9aef06",
    ...
    // Wide (3840x2160 / 4K)
    // NOTE: The `date` field on horizontal hyperlapses below is used as a
    // DISPLAY ORDER KEY rather than a real shoot date. Real shoot dates were
    // last week of March 2026 for MMW pieces and spring 2026 for the drone
    // showcase work. We chose synthetic descending dates so the date-based
    // sort produces the user's hand-curated display order on /work.
    {
      image: "",
      title: "DOWNTOWN INDY",
      client: "Sweet Dreams Media",
      ...
      date: "2026-05-06",
      isSmartVideo: true,
      videoId: "600724a4c38d9a09859930c674e28682",
      orientation: "horizontal" as const,
    },
    {
      image: "",
      title: "OHIO STATE STADIUM",
      client: "Sweet Dreams Media",
      logo: "https://fweeyjnqwxywmpmnqpts.supabase.co/storage/v1/object/public/media/logos/SWEETDREAMSLOGO_1.jpg",
      tags: ["hyperlapse", "aerial"],
      date: "2026-05-05",
      isSmartVideo: true,
      videoId: "cf441d4889ad723cce8a6c778322f22a",
      orientation: "horizontal" as const,
    },
    {
      image: "",
      title: "BROWNIE'S LEMONADE INFLATABLE",
      client: "Brownies & Lemonade",
      logo: "https://fweeyjnqwxywmpmnqpts.supabase.co/storage/v1/object/public/media/logos/SWEETDREAMSLOGO_1.jpg",
      tags: ["hyperlapse"], // Camera-shot — no aerial tag
      date: "2026-05-04",
      isSmartVideo: true,
      videoId: "4521e4c524c56ea4852900115f401008",
      orientation: "horizontal" as const,
    },
    {
      image: "",
      title: "TINCAPS — STRAIGHT DOWN",
      client: "Fort Wayne TinCaps",
      logo: "https://fweeyjnqwxywmpmnqpts.supabase.co/storage/v1/object/public/media/logos/SWEETDREAMSLOGO_1.jpg",
      tags: ["hyperlapse", "aerial"],
      date: "2026-04-23",
      isSmartVideo: true,
      videoId: "0e76da8004f6d65fcbaaf3fd5d15af2f",
      orientation: "horizontal" as const,
    },
    {
      image: "",
      title: "TINCAPS — NIGHTTIME",
      client: "Fort Wayne TinCaps",
      logo: "https://fweeyjnqwxywmpmnqpts.supabase.co/storage/v1/object/public/media/logos/SWEETDREAMSLOGO_1.jpg",
      tags: ["hyperlapse", "aerial"],
      date: "2026-05-02",
      isSmartVideo: true,
      videoId: "5666f75982a06a8915447ce07b9c21f7",
      orientation: "horizontal" as const,
    },
    {
      image: "",
      title: "FORT WAYNE DOWNTOWN",
      client: "Sweet Dreams Media",
      logo: "https://fweeyjnqwxywmpmnqpts.supabase.co/storage/v1/object/public/media/logos/SWEETDREAMSLOGO_1.jpg",
      tags: ["hyperlapse", "aerial"],
      date: "2026-05-01",
      isSmartVideo: true,
      videoId: "9f61937e0a34d5fd01bc176bf355bb87",
      orientation: "horizontal" as const,
    },
    {
      image: "",
      title: "FORT WAYNE NIGHT TRAFFIC",
      client: "Sweet Dreams Media",
      logo: "https://fweeyjnqwxywmpmnqpts.supabase.co/storage/v1/object/public/media/logos/SWEETDREAMSLOGO_1.jpg",
      tags: ["hyperlapse", "aerial"],
      date: "2026-04-30",
      isSmartVideo: true,
      videoId: "074c7883d593cad3330c4c340fc18c37",
      orientation: "horizontal" as const,
    },
    {
      image: "",
      title: "FORT WAYNE TRAFFIC — STRAIGHT DOWN",
      client: "Sweet Dreams Media",
      logo: "https://fweeyjnqwxywmpmnqpts.supabase.co/storage/v1/object/public/media/logos/SWEETDREAMSLOGO_1.jpg",
      tags: ["hyperlapse", "aerial"],
      date: "2026-04-20",
      isSmartVideo: true,
      videoId: "d7cfc9bc24cb2f9a94882962c28d3bd5",
      orientation: "horizontal" as const,
    },
    {
      image: "",
      title: "CHICAGO SKYLINE TRAIN",
      client: "Sweet Dreams Media",
      logo: "https://fweeyjnqwxywmpmnqpts.supabase.co/storage/v1/object/public/media/logos/SWEETDREAMSLOGO_1.jpg",
      tags: ["hyperlapse", "aerial"],
      date: "2026-04-29",
      isSmartVideo: true,
      videoId: "1dbe19ee26b32ed11fb2c39d839396df",
      orientation: "horizontal" as const,
    },
    {
      image: "",
      title: "AEGIS DENTAL BUILDING",
      client: "Aegis Dental Group",
      logo: "https://fweeyjnqwxywmpmnqpts.supabase.co/storage/v1/object/public/media/logos/TrustedDentalLogo.png",
      tags: ["hyperlapse", "aerial", "business"],
      date: "2026-04-28",
      isSmartVideo: true,
      videoId: "3ea9877597d5ed818b82c2903b9b0f28",
      orientation: "horizontal" as const,
    },

    // Existing Mana Wynwood / Wynwood Marketplace MMW horizontals (camera)
    {
      image: "",
      title: "COLOR WALL",
      client: "Mana Wynwood",
