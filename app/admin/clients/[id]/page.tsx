  ...
  const { data } = await supabase
    ...
    .select(
      `id, created_at, business_name, contact_name, email, phone, auth_user_id, source_lead_id, admin_notes,
       sites (id, name, domain, status, hosting_price_cents, update_hours_per_quarter, build_price_cents, billing_anchor_day, db_mode, db_project_ref, github_repo, vercel_project_id, live_url, go_live_date, admin_notes),
