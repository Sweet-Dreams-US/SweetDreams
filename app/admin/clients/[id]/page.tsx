  ...
  const { data } = await supabase
    ...
    .select(
      `id, created_at, business_name, contact_name, email, phone, auth_user_id, source_lead_id, admin_notes, stripe_customer_id, payment_method_saved_at,
       sites (id, name, domain, demo_url, preview_url, drive_url, status, hosting_price_cents, min_hosting_price_cents, update_hours_per_quarter, build_price_cents, billing_anchor_day, db_mode, db_project_ref, analytics_addon, github_repo, vercel_project_id, live_url, go_live_date, admin_notes, stripe_subscription_id, billing_starts_on, builder),
